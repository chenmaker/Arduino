...
void PMxx_cnt_bsc(void){
  ...
  unsigned int pmcount10=gucRxBuf[20]*256+gucRxBuf[21];  Serial.print("PMcount1.0:");   Serial.println(pmcount10);
               pmcount25=gucRxBuf[22]*256+gucRxBuf[23];  Serial.print("PMcount2.5:");   Serial.println(pmcount25);
}
...
float humi;
    ...
    if (((gucRxBuf[0]==0x42)&&(gucRxBuf[1]==0x4d))&&(i>=12)){
      ...
      if((csH==gucRxBuf[DTL+2])&&(csL==gucRxBuf[DTL+3])){
        ...
        PMxx_info();
        PMxx_cnt_bsc();
        temp=(float)(gucRxBuf[24]*256+gucRxBuf[25])/10;  Serial.print("Temperature:");  Serial.print(temp,1);       Serial.println(" C");
        humi=(float)(gucRxBuf[26]*256+gucRxBuf[27])/10;  Serial.print("Humidity:");     Serial.print(humi,1);       Serial.println(" %");
